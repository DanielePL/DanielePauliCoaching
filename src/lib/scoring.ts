...
// HINWEIS: Indizes 0-basiert nach Fragen-Array in Survey.tsx.
// Treiber (Q8) & Blocker (Q1) sind deskriptiv und fliessen NICHT in den Score.
// Freitext-Fragen (Q9, Q20) sind ebenfalls nicht gewertet.
const QUESTION_WEIGHTS: Record<number, { weight: number; scores: number[] }> = {
  ...
  10: { weight: 0.8, scores: [1.0, 0.75, 0.5, 0.4] },       // Erhaltungsplan

  // Phase 4: COMMITMENT (am stärksten gewichtet)
  11: { weight: 1.5, scores: [1.0, 0.75, 0.5, 0.25] },      // Bereitschaft Prioritäten
  12: { weight: 1.0, scores: [1.0, 0.8, 0.6, 0.4] },        // Umgang mit Feedback
  13: { weight: 0.8, scores: [1.0, 0.8, 0.6, 0.5] },        // Accountability
  ...
  21: { weight: 0.3, scores: [0.5, 0.7, 0.85, 1.0, 0.2] },  // Investment
};
